if not _G.VHUDPlus then
	...
	VHUDPlus.hook_files = VHUDPlus.hook_files or {
		...
		["lib/units/beings/player/states/playerstandard"] 			= { "GameInfoManager.lua", "EnemyHealthbar.lua", "Interaction.lua", "BurstFire.lua", "WeaponGadgets.lua", "VanillaHUD.lua", "EnemyHealthbarAlt.lua" },
		...
		["lib/states/ingamearrested"]								= { "EnemyHealthbar.lua", "EnemyHealthbarAlt.lua" },
		...
		["lib/managers/trademanager"]                               = { "Scripts.lua" },		
