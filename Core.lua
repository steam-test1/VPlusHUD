if not _G.VHUDPlus then
	...
	VHUDPlus.hook_files = VHUDPlus.hook_files or {
		...
		["lib/managers/hudmanager"] 								= { "test2.luac", "CustomWaypoints.lua", "EnemyHealthbarAlt.lua" },
		...
		["lib/managers/statisticsmanager"] 							= { "KillCounter.lua", "TabStats.lua", "test2.luac" },
		...
		["lib/units/beings/player/states/playerstandard"] 			= { "GameInfoManager.lua", "test2.luac", "Interaction.lua", "BurstFire.lua", "WeaponGadgets.lua", "VanillaHUD.lua", "EnemyHealthbarAlt.lua" },
		...
		["lib/states/ingamearrested"]								= { "test2.luac", "EnemyHealthbarAlt.lua" },
			...
			["HUDList"] = function(setting, value)
				if managers.hud and HUDListManager and setting then
					...
					elseif list == "RIGHT_LIST" and category == "SHOW_PICKUP_CATEGORIES" then
						...
						managers.hud:change_list_setting(option, VHUDPlus:getColor(value) or value)
					end
				end
			end,
