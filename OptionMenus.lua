				...
				options = {
					...
					{ -- Damagepopup
						...
						options = {
							{
								type = "toggle",
								name_id = "wolfhud_dmg_popup_linux_compat_title",
								desc_id = "wolfhud_dmg_popup_linux_compat_desc",
								visible_reqs = {}, enabled_reqs = {},
								value = {"DamagePopup", "LINUXCOMPAT"},
							},
							{
								type = "toggle",
