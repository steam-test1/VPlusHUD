if string.lower(RequiredScript) == "lib/managers/hud/hudassaultcorner" then
	...
	function HUDAssaultCorner:init(tweak_hud, ...)
		...
		if VHUDPlus:getSetting({"AssaultBanner", "USE_CENTER_ASSAULT"}, true) then
...
elseif string.lower(RequiredScript) == "lib/managers/hudmanagerpd2" then
	...
	function HUDManager:show_casing(...)
		...
		if self:alive("guis/mask_off_hud") and VHUDPlus:getSetting({"AssaultBanner", "USE_CENTER_ASSAULT"}, true) then
