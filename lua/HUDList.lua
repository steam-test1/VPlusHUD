...
if string.lower(RequiredScript) == "lib/managers/hudmanagerpd2" then
	...
	function HUDListManager:_setup_buff_list()
		...
		if VHUDPlus:getSetting({"HUDList", "mui_buff_fix"}, false) then
			y = hud_panel:bottom() - ((HUDListManager.ListOptions.buff_list_height_offset or 90) - 10)
		else
	...
	HUDList.BuffItemBase.MAP = {
		...
		chico_injector = {
			...
			priority = 4,
			color = HUDList.BuffItemBase.ICON_COLOR.STANDARD,
			ignore = not VHUDPlus:getSetting({"HUDList", "BUFF_LIST", "PERK_BUFFS", "chico_injector"}, false) and (VHUDPlus:getSetting({"CustomHUD", "PLAYER", "STATUS"}, true) or VHUDPlus:getSetting({"CustomHUD", "ENABLED"}, false)),
		},
		close_contact = {
			perks = {5, 4},
			class = "TimedBuffItem",
		...
		maniac = {
			...
			color = HUDList.BuffItemBase.ICON_COLOR.STANDARD,
			show_value = "-%.1f",
			ignore = not VHUDPlus:getSetting({"HUDList", "BUFF_LIST", "PERK_BUFFS", "maniac"}, false) and (VHUDPlus:getSetting({"CustomHUD", "PLAYER", "STATUS"}, true) or VHUDPlus:getSetting({"CustomHUD", "ENABLED"}, false)),
		},
		messiah = {
		...
		swan_song = {
			...
			priority = 4,
			color = HUDList.BuffItemBase.ICON_COLOR.STANDARD,
			ignore = not VHUDPlus:getSetting({"HUDList", "BUFF_LIST", "FUGITIVE_BUFFS", "swan_song"}, false) and (VHUDPlus:getSetting({"CustomHUD", "PLAYER", "STATUS"}, true) or VHUDPlus:getSetting({"CustomHUD", "ENABLED"}, false)),
		},
		tag_team = {
			perks = {0, 0},
			...
			color = HUDList.BuffItemBase.ICON_COLOR.STANDARD,
			show_value = true,
			ignore = not VHUDPlus:getSetting({"HUDList", "BUFF_LIST", "PERK_BUFFS", "tag_team"}, true) and (VHUDPlus:getSetting({"CustomHUD", "PLAYER", "STATUS"}, true) or VHUDPlus:getSetting({"CustomHUD", "ENABLED"}, false)),
		},
		tooth_and_claw = {
			perks = {0, 3},
			class = "TimedBuffItem",
